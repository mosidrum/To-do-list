...
> This project is to display a list of task to be done by a user 
...
```sh
  cd my-folder
  git clone git@github.com:mosidrum/To-do-list.git
```
...
Feel free to check the [issues page](https://github.com/mosidrum/To-do-list/issues)
<p align="right">(<a href="#readme-top">back to top</a>)</p>
